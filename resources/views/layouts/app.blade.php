...
<head>
    ...
    <title>Ketimbang Ngemis Pontianak</title>
            ...
            <div class="container">
                ...
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    ...
                    <ul class="navbar-nav me-auto">
                        ...
                        <li class="nav-item">
                            <a class="nav-link" href="/category/2"><i class=""></i> Sosok Inspiratif</a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link" href="/category/3"><i class=""></i> TSSI</a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link" href="/category/4"><i class=""></i> Tentang</a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link" href="/category/6"><i class=""></i> Education</a>
                        </li>
                        @auth
                        <li class="nav-item">
